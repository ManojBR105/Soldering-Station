...
Serial.print("Init: [");
for (byte i = 0; i < 3; ++i) {
  Serial.print(t_tip[i]);
  if (i <2) Serial.print(",");
}
Serial.print("], temp = "); Serial.print(Config.temp);
Serial.print("; "); Serial.print(Config.off_timeout, DEC);
Serial.print(", "); Serial.println(Config.celsius, DEC);
}
...
Serial.print("Failed to heat. temp_set = "); Serial.print(temp_set);
Serial.print(", temp = "); Serial.print(temp);
Serial.print(", temp_start = "); Serial.println(temp_start);
...
void workSCREEN::init(void) {
  ...
  auto_off_notified = 0;
  forceRedraw();
Serial.print("Start heating. temp_set = "); Serial.println(temp_set);
}
